...
import { Icon, Image, Button, Input, Upload, Notification } from 'components/Base';
...
export default class AppAdd extends Component {
  ...
  renderVersionTypes() {
    ...
    const { versionTypes, activeStep } = appCreateStore;
    return (
          ...
          <div>
            ...
            <Upload checkFile={checkIconFile} uploadFile={uploadIcon}>
              <span className={styles.appIcon}>
                ...
                {!icon && <span className={styles.iconText}>{t('Select a file')}</span>}
              </span>
            </Upload>
